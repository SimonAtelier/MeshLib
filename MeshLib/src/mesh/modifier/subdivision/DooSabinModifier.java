...
public class DooSabinModifier implements IMeshModifier {
	 ...
	 * 
	 * @param face
	 *            the face (polygon) the original vertex belongs to
	 * @param center
	 *            the face point (average of the vertices of the polygon)
	 * @param i
	 *            the index of the first adjacent vertex (references to the vertex
	 *            list of the mesh)
	...
	/*
	 * (non-Javadoc)
	 * @see mesh.modifier.IMeshModifier#modify(mesh.Mesh3D)
	 */
	@Override
